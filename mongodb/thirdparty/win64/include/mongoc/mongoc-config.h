...
#define MONGOC_USER_SET_CFLAGS " /nologo /DWIN32 /D_WINDOWS /W3 /utf-8 /MP "

#define MONGOC_USER_SET_LDFLAGS "/machine:x64"

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "C:/Program Files (x86)/Microsoft Visual Studio/2022/BuildTools/VC/Tools/MSVC/14.37.32822/bin/Hostx64/x64/cl.exe"
